...
void tampilan_data_half(list &head) {
...
void tampilan_data_nasabah_individu(list &head, std::string judul){
    loading();
    tampilan_judul_submenu(judul, 40);
...
// Menu Mekanisme Pengklasifikasian
void klasifikasi() {
    system("cls");
